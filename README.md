...
本牌组在 GitHub（此处）、[AnkiWeb](https://ankiweb.net/shared/info/832276382) 和 [墨墨记忆卡（Markji）](https://www.markji.com/deck/699faa1d51fa678290828e51) 免费提供。
...
导入更新会覆盖本地对牌组内容、标签、字段和模板做过的自定义修改。如需保留自定义内容，请不要直接覆盖导入，建议先使用 [anki-apkg-extractor](https://github.com/5mdld/anki-apkg-extractor) 提取元数据，再手动比对处理。
...
请参考 [更新牌组](#更新牌组) 中关于已删除卡片和版本标签的说明。
...
- GitHub：可通过 [Issues](https://github.com/5mdld/anki-jlpt-decks/issues) 或 [Discussions](https://github.com/5mdld/anki-jlpt-decks/discussions) 反馈牌组问题。
- Telegram：[交流群](https://t.me/+N7bNc8-BpqJjZmQ1)
- 作者其他 Anki 牌组与插件：[AnkiWeb 主页](https://ankiweb.net/shared/by-author/842333142)

## 友情链接

- `MasterOfMasterSword` 的文法和单词牌组：[AnkiWeb](https://ankiweb.net/shared/by-author/1681155450)
