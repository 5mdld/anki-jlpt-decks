...
凡在闲鱼及拼多多等平台付费售卖本牌组的，均未经作者授权，请勿购买。

> 墨墨记忆卡（Markji）是一款更轻量、更易上手的间隔重复闪卡 APP，目前支持 iOS 和 Android。它采用 MMX 记忆算法，与 Anki 使用的 FSRS 算法同源，能够根据记忆规律智能安排复习，帮助用户用更少时间记得更牢。相比 Anki，Markji 更开箱即用，适合希望快速开始、长期坚持的学习者。
...
- 单词音频：绝大部分为真人播音员录制。
- 例句音频：使用 [VOICEPEAK](https://www.ah-soft.com/voice/6nare/index.html) 生成，并经过人工校对。
- 音频按钮：
  - 黑白播放按钮：牌组自带本地音频
...
本节是 Anki 用户的详细安装说明；墨墨记忆卡（Markji）用户直接打开 [墨墨记忆卡（Markji）牌组页面](https://www.markji.com/deck/699faa1d51fa678290828e51) 即可使用。

0. 请使用官方最新版 Anki 或 AnkiDroid。本牌组不保证兼容旧版 Anki，也不保证兼容 AnkiApp、AnkiPro 等类 Anki 应用。
   > Android 用户请勿使用「Anki 中国」提供的 AnkiDroid v2.16.0beta2，该版本存在兼容性问题。

1. 安装官方 Anki：

   - Windows / macOS / Linux：[Anki 官网](https://apps.ankiweb.net/) ｜ [GitHub Releases](https://github.com/ankitects/anki/releases/latest)
   - iOS / iPadOS：[AnkiMobile Flashcards](https://apps.apple.com/jp/app/ankimobile-flashcards/id373493387)
   - Android：[Play Store](https://play.google.com/store/apps/details?id=com.ichi2.anki) ｜ [GitHub Releases](https://github.com/ankidroid/Anki-Android/releases/latest)

2. 下载最新版牌组：[Releases 页面](https://github.com/5mdld/anki-jlpt-decks/releases)
   > 请下载 `.apkg` 文件，不要下载其他文件！

3. 在 Anki 中导入刚才下载的 `.apkg` 文件。

4. 首次导入时，建议如图所示打开「导入所有牌组预设配置」，以应用牌组自带预设。

![导入选项](https://pub-90b0b2afa26447b8b824c3d05d8e274f.r2.dev/uPic/20250527Mzfbc2.png)

5. 注册并登录 [AnkiWeb 账号](https://ankiweb.net/account/signup) 后，可以同步多设备学习进度并进行云端备份。
...
- Anki 官方手册：[简体中文](https://open-spaced-repetition.github.io/anki-manual-zh-CN/intro.html) ｜ [English](https://docs.ankiweb.net/)
- 迁移学习记录插件：[Transfer Scheduling Info Advanced](https://ankiweb.net/shared/info/1249258442)
- 更新时保护自定义字段插件：[Special Fields](https://ankiweb.net/shared/info/1102281552)

## 更新与迁移

> 更新或迁移前，请先备份 Anki 数据。
![000](https://pub-90b0b2afa26447b8b824c3d05d8e274f.r2.dev/uPic/20260518g6yi7y.png)

### 更新牌组

稳定版通常每 **1 至 2 个月**发布一次。更新方法是下载最新版 `.apkg` 文件并再次导入 Anki（可参考 [从 v3 升级到 v3.5](#从-v3-升级到-v35) 的前两步）。正常更新不会影响学习进度。
...
![003](https://pub-90b0b2afa26447b8b824c3d05d8e274f.r2.dev/uPic/20260518YDe3qQ.png)
![004](https://pub-90b0b2afa26447b8b824c3d05d8e274f.r2.dev/uPic/20260518fzMRxv.png)
![005](https://pub-90b0b2afa26447b8b824c3d05d8e274f.r2.dev/uPic/20260518g8CQcE.png)
![007](https://pub-90b0b2afa26447b8b824c3d05d8e274f.r2.dev/uPic/20260518izMtVR.png)
![008](https://pub-90b0b2afa26447b8b824c3d05d8e274f.r2.dev/uPic/20260518GTheN8.png)
![009](https://pub-90b0b2afa26447b8b824c3d05d8e274f.r2.dev/uPic/202605185lOB28.png)
![012](https://pub-90b0b2afa26447b8b824c3d05d8e274f.r2.dev/uPic/20260518cAmSTu.png)
![013](https://pub-90b0b2afa26447b8b824c3d05d8e274f.r2.dev/uPic/20260518jpISw5.png)
...
1. 下载并导入 v3 新版牌组。
2. 在桌面端安装 [Transfer Scheduling Info Advanced](https://ankiweb.net/shared/info/1249258442) 插件，插件代码为 `1249258442`。
3. 按插件界面迁移学习记录。
4. 如果您启用了「中-日」模板，请先在新牌组中也开启「中-日」模板，确认浏览页面中出现对应卡片后再迁移。
5. 迁移完成后，可删除旧版 v2 牌组。
...
可在 Anki「设置」→「显示驱动」中尝试选择 `Software` 或 `OpenGL`。

### 卡片正面的单词上有假名标注

本牌组只对「[常用漢字表](https://www.bunka.go.jp/kokugo_nihongo/sisaku/joho/joho/kijun/naikaku/pdf/joyokanjihyo_20101130.pdf)」范围外的词汇添加假名标注，并非所有单词都有。一般无需隐藏；如需隐藏，请参考 [设置正面单词显示方式](#设置正面单词显示方式)。
...
需要手动处理，请参考 [更新牌组](#更新牌组)｜[从 v3 升级到 v3.5](#从-v3-升级到-v35)｜[从 v2 升级到 v3](#从-v2-升级到-v3) 。

### 一些发音听起来不对

例如「だいがく」中的「が」听起来像「な」，或「ふくそう」听起来像「くそう」，通常与 [鼻濁音](https://zh.wikipedia.org/wiki/%E9%BC%BB%E6%BF%81%E9%9F%B3) 和 [母音の無声化](https://spot-pj.com/glossary/no28-vowel-devoicing/) 有关，不一定是错误。
...
桌面端调试插件：[AnkiWebView Inspector](https://ankiweb.net/shared/info/31746032)
...
| ------------------------------------ | ------------------------ | ----------- | -------------------- |
| 正反面自动播放全部音频               | 关闭「不要自动播放音频」 | `'default'` | 是                   |
| 正面自动播放，背面只播放单词         | 关闭「不要自动播放音频」 | `'force'`   | 是                   |
| 正面手动播放，背面只播放单词         | 开启「不要自动播放音频」 | `'force'`   | 是                   |
| 正面手动播放，背面手动播放           | 开启「不要自动播放音频」 | `'default'` | 是                   |
| 正面不发音，背面播放单词和例句       | 关闭「不要自动播放音频」 | `'default'` | 否                   |
| 正面不发音，背面只播放单词，默认设置 | 开启「不要自动播放音频」 | `'force'`   | 否                   |
| 正反面都不发音                       | 开启「不要自动播放音频」 | `'default'` | 否                   |
...
修改 `frontExamples` 参数（此选项仅适用于卡片正面，背面始终显示全部内容）：
...
<details>
<summary>点击展开在线 TTS 配置</summary><br>

可通过 `tts` 配置控制在线 TTS：

```js
tts: {
  enable: 'never',    // 在线 TTS 开关: 'always' 始终开启 | 'fallback' 无本地音频时启用 | 'never' 始终关闭
...
可参考 [ms-ra-forwarder-for-ifreetime](https://github.com/yy4382/ms-ra-forwarder-for-ifreetime) 搭建自己的 TTS 服务（选择**无 token** 部署，建议自定义域名设置得复杂一些避免泄露）。
...
<details>
<summary>点击展开开启和关闭方法</summary><br>
...
本牌组由 **egg rolls** 制作，内容来源于公开互联网资源及个人创作，遵循 [CC BY-NC 4.0](https://creativecommons.org/licenses/by-nc/4.0/deed.zh-hans) 协议。

您可以自由使用、修改和分享本牌组，但需遵守以下条件：
