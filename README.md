...
凡在闲鱼及拼多多等平台付费售卖本牌组的，均为假冒，请勿购买。

> 墨墨记忆卡（Markji）是一款更轻量、更易上手的间隔重复闪卡 APP，目前支持 iOS 和 Android。它采用 MMX 记忆算法，与 Anki 也在使用的 FSRS 算法同源，能够根据记忆规律智能安排复习，帮助用户用更少时间记得更牢。相比 Anki，Markji 更开箱即用，适合希望快速开始、长期坚持的学习者。
...
本牌组只对「[常用漢字表](https://www.bunka.go.jp/kokugo_nihongo/sisaku/joho/joho/kijun/naikaku/pdf/joyokanjihyo_20101130.pdf)」范围外的词汇添加假名标注，并非所有单词都有。一般无需隐藏；如需隐藏，请参考 [控制正面单词显示模式](#控制正面单词显示模式)。
