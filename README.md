...
本牌组免费发布于 GitHub（本仓库）和 [AnkiWeb](https://ankiweb.net/shared/info/832276382)，另提供 [墨墨记忆卡（Markji）](https://www.markji.com/deck/699faa1d51fa678290828e51) 版本。凡在闲鱼等平台付费售卖本牌组的，均为假冒，请勿购买。
...
> 更新或迁移前，请先备份 Anki 数据。
如何备份：![000](https://pub-90b0b2afa26447b8b824c3d05d8e274f.r2.dev/uPic/20260518g6yi7y.png)

### 更新牌组

稳定版通常每 **1 至 2 个月**发布一次。更新方法是下载最新版 `.apkg` 文件并再次导入 Anki（可参考 [从 v3 升级到 v3.5](#从 v3 升级到 v3.5) 的前两步）。正常更新不会影响学习进度。
...
需要手动处理，请参考 [更新牌组](#更新牌组)｜[从 v3 升级到 v3.5](#从 v3 升级到 v3.5)｜[从 v2 升级到 v3](#从 v2 升级到 v3) 。
