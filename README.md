...
直接打开 [墨墨记忆卡（Markji）牌组页面](https://www.markji.com/deck/699faa1d51fa678290828e51) 开始使用。
...
注册并登录 [AnkiWeb 账号](https://ankiweb.net/account/signup) 后，可以同步多设备学习进度并进行云端备份。
...
稳定版通常每 **1 至 2 个月**发布一次。更新方法是下载最新版 `.apkg` 文件并再次导入 Anki。正常更新不会影响学习进度。
